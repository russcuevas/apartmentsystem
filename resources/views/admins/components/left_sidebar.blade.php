<aside class="sidebar-aside" id="sidebarAside">
        ...
        <a href="{{ route('admin.dashboard') }}" class="sidebar-logo">
            <div class="logo-icon">
                ...
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M19 2H9c-1.1 0-2 .9-2 2v3H3c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM5 20H3V9h2v11zm4 0H7v-3h2v3zm0-5H7v-3h2v3zm0-5H7V7h2v3zm10 10h-8V4h8v16zm-2-12h-4v2h4V8zm0 4h-4v2h4v-2zm0 4h-4v2h4v-2z"/>
                </svg>
            </div>
    ...
    <div class="sidebar-content">
        ...
        <ul class="sidebar-menu">
            <!-- Dashboard Link -->
            <li>
                <a href="{{ route('admin.dashboard') }}" class="menu-item-link active">
